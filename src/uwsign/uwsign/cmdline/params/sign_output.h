...
/**
 * @file        sign_output.h
 * @brief       uwsign sign output command line parameter
 * @author      MacroModel
 * @version     v1.0.0.0
...
UWSIGN_MODULE_EXPORT namespace uwsign::uwsign::cmdline::params
{
    namespace details
    {
        inline bool sign_output_is_exist{};  // [global]
        inline constexpr ::uwsign::utils::container::array<::uwsign::utils::container::u8string_view, 2uz> sign_output_alias{u8"-o", u8"--out"};
    }
...
#endif
    inline constexpr ::uwsign::utils::cmdline::parameter sign_output{
        .name{u8"--output"},
        .describe{u8"Set signed output file."},
        .usage{u8"<file>"},
        .alias{::uwsign::utils::cmdline::kns_u8_str_scatter_t{details::sign_output_alias.data(), details::sign_output_alias.size()}},
        .handle{::std::addressof(details::required_value_callback)},
        .pretreatment{::std::addressof(details::required_value_pretreatment)},
        .is_exist{::std::addressof(details::sign_output_is_exist)},
