...
/**
 * @file        sign_output_signature.cppm
 * @brief       uwsign output signature command line parameter module
 * @author      MacroModel
 * @version     v1.0.0.0
...
export module uwsign.uwsign.cmdline.params:sign_output_signature;
