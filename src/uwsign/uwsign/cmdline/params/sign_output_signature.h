...
/**
 * @file        sign_output_signature.h
 * @brief       uwsign output signature command line parameter
 * @author      MacroModel
 * @version     v1.0.0.0
...
UWSIGN_MODULE_EXPORT namespace uwsign::uwsign::cmdline::params
{
    namespace details
    {
        inline bool sign_output_signature_is_exist{};  // [global]
    }
...
#endif
    inline constexpr ::uwsign::utils::cmdline::parameter sign_output_signature{
        .name{u8"--output-signature"},
        .describe{u8"Write a detached signature file."},
        .usage{u8"<file>"},
        .handle{::std::addressof(details::required_value_callback)},
        .pretreatment{::std::addressof(details::required_value_pretreatment)},
        .is_exist{::std::addressof(details::sign_output_signature_is_exist)},
