...
/**
 * @file        sign_certificate_chain.cppm
 * @brief       uwsign certificate chain command line parameter module
 * @author      MacroModel
 * @version     v1.0.0.0
...
export module uwsign.uwsign.cmdline.params:sign_certificate_chain;
