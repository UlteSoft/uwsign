...
/**
 * @file        sign_output_certificate_chain.cppm
 * @brief       uwsign output certificate chain command line parameter module
 * @author      MacroModel
 * @version     v1.0.0.0
...
export module uwsign.uwsign.cmdline.params:sign_output_certificate_chain;
