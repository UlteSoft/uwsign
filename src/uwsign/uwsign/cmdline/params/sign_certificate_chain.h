...
/**
 * @file        sign_certificate_chain.h
 * @brief       uwsign certificate chain command line parameter
 * @author      MacroModel
 * @version     v1.0.0.0
...
UWSIGN_MODULE_EXPORT namespace uwsign::uwsign::cmdline::params
{
    namespace details
    {
        inline bool sign_certificate_chain_is_exist{};  // [global]
    }
...
#endif
    inline constexpr ::uwsign::utils::cmdline::parameter sign_certificate_chain{
        .name{u8"--certificate-chain"},
        .describe{u8"Set a PEM certificate chain for signing or verification."},
        .usage{u8"<file>"},
        .handle{::std::addressof(details::required_value_callback)},
        .pretreatment{::std::addressof(details::required_value_pretreatment)},
        .is_exist{::std::addressof(details::sign_certificate_chain_is_exist)},
