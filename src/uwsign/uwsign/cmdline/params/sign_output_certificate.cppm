...
/**
 * @file        sign_output_certificate.cppm
 * @brief       uwsign output certificate command line parameter module
 * @author      MacroModel
 * @version     v1.0.0.0
...
export module uwsign.uwsign.cmdline.params:sign_output_certificate;
