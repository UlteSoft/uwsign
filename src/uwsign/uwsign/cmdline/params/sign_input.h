...
/**
 * @file        sign_input.h
 * @brief       uwsign sign input command line parameter
 * @author      MacroModel
 * @version     v1.0.0.0
...
UWSIGN_MODULE_EXPORT namespace uwsign::uwsign::cmdline::params
{
    namespace details
    {
        inline bool sign_input_is_exist{};  // [global]
        inline constexpr ::uwsign::utils::container::array<::uwsign::utils::container::u8string_view, 2uz> sign_input_alias{u8"-i", u8"--in"};
    }
...
#endif
    inline constexpr ::uwsign::utils::cmdline::parameter sign_input{
        .name{u8"--input"},
        .describe{u8"Set input file to sign."},
        .usage{u8"<file>"},
        .alias{::uwsign::utils::cmdline::kns_u8_str_scatter_t{details::sign_input_alias.data(), details::sign_input_alias.size()}},
        .handle{::std::addressof(details::required_value_callback)},
        .pretreatment{::std::addressof(details::required_value_pretreatment)},
        .is_exist{::std::addressof(details::sign_input_is_exist)},
