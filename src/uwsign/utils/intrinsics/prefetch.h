...
UWSIGN_MODULE_EXPORT namespace uwsign::utils::intrinsics::universal
{
    enum class pfc_mode
    {
        read = 0,
    ...
    UWSIGN_GNU_ALWAYS_INLINE_ARTIFICIAL UWSIGN_GNU_NODEBUG UWSIGN_NO_SANITIZE inline void prefetch(void const* address) noexcept
    {
    ...
    UWSIGN_HAS_BUILTIN(__builtin_arm_prefetch)  // Only Clang
...
#elif UWSIGN_HAS_BUILTIN(__builtin_ia32_prefetchi)  // Clang + GCC
...
#elif UWSIGN_HAS_BUILTIN(__builtin_prefetch)  // Clang + GCC
