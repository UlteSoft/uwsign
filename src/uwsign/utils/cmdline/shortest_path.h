...
UWSIGN_MODULE_EXPORT namespace uwsign::utils::cmdline
{
    ...
    UWSIGN_GNU_PURE inline constexpr ::std::size_t shortest_path(char_type const* x_str,
                                                               ::std::size_t x_length,
                                                               ...
                                                               ::std::size_t y_length) noexcept
    {
        ...
        ::std::size_t* d{};
        [[maybe_unused]] ::uwsign::utils::container::array<::std::size_t, Stack_Len> storage;
        ...
        else
        {
            ...
            if UWSIGN_IF_CONSTEVAL { d = ::new ::std::size_t[alloc_length]; }
            else
            {
        ...
        {
            if UWSIGN_IF_CONSTEVAL { ::delete[] d; }
            else
            {
