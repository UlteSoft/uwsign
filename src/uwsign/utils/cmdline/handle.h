...
UWSIGN_MODULE_EXPORT namespace uwsign::utils::cmdline
{
    ...
    {
        arg,                  // normal args
        occupied_arg,         // The occupied args are consumed by preprocessing
    ...
    {
        ::uwsign::utils::container::u8cstring_view str{};  // Parameter content
    ...
    using kns_u8_str_scatter_t = ::fast_io::basic_io_scatter_t<::uwsign::utils::container::u8string_view>;
    ...
    using parameter_func_type =
        void (*)(char8_t const* const*& argv_curr, char8_t const* const* argv_end, ::uwsign::utils::container::vector<parameter_parsing_results>& pr) noexcept;
    ...
    struct parameter
    {
        ::uwsign::utils::container::u8string_view const name{};      // parameter name
        ::uwsign::utils::container::u8string_view const describe{};  // describtion shown in help
        ::uwsign::utils::container::u8string_view const usage{};     // usage shown in help
    ...
    {
        ::uwsign::utils::container::array<parameter const*, N> res{};
    ...
    {
        ::uwsign::utils::container::u8string_view str{};  // raw name or alias name
    ...
    ///             This function only allows consteval to implement.
    template <::std::size_t N>
    inline consteval ::std::size_t calculate_alias_parameters_size(::uwsign::utils::container::array<parameter const*, N> const& punsort) noexcept
    {
        ::std::size_t res{};
    ...
    inline consteval auto expand_alias_parameters_and_check(::uwsign::utils::container::array<parameter const*, N> const& punsort) noexcept
    {
        ::uwsign::utils::container::array<alias_parameter, AllParaSize> res{};
        ::std::size_t res_pos{};
        ...
        // check is invalid
        ::uwsign::utils::container::u8string_view check{};  // Empty strings will be sorted and placed first.
    ...
    template <::std::size_t N>
    inline consteval ::std::size_t calculate_max_principal_name_size(::uwsign::utils::container::array<parameter const*, N> const& punsort) noexcept
    {
        ::std::size_t max_size{};
    ...
    template <::std::size_t N>
    inline consteval ::std::size_t calculate_max_para_size(::uwsign::utils::container::array<alias_parameter, N> const& punsort) noexcept
    {
        ::std::size_t max_size{};
    ...
    template <::std::size_t N>
    inline consteval calculate_hash_table_size_res calculate_hash_table_size(::uwsign::utils::container::array<alias_parameter, N> const& ord) noexcept
    {
        constexpr auto sizet_d10{static_cast<::std::size_t>(::std::numeric_limits<::std::size_t>::digits10)};

        ::uwsign::utils::hash::xxh3_64bits_context xxh3{};
    ...
    struct ht_para_cpos
    {
        ::uwsign::utils::container::u8string_view str{};
    ...
    struct conflict_table
    {
        ...
        ::uwsign::utils::container::array<ct_para_str, real_max_conflict_size + 1uz> ctmem{};
    };
    ...
    struct parameters_hash_table
    {
        ...
        // Hash Table
        ::uwsign::utils::container::array<ht_para_cpos, hash_table_size> ht{};
        // Conflict Table
        ::std::conditional_t<static_cast<bool>(conflict_size),
                             ::uwsign::utils::container::array<conflict_table<real_max_conflict_size>, conflict_size>,
                             ::std::in_place_t>
            ct{};
    };
    ...
    inline consteval auto generate_hash_table(::uwsign::utils::container::array<alias_parameter, N> const& ord) noexcept
    {
    ...
    inline constexpr parameter const* find_from_hash_table(parameters_hash_table<hash_table_size, conflict_size, real_max_conflict_size> const& ght,
                                                           ::uwsign::utils::container::u8string_view str) noexcept
    {
        ::uwsign::utils::hash::xxh3_64bits_context xxh3{};
