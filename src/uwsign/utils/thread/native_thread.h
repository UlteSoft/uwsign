...
#pragma push_macro("UWSIGN_UTILS_THREAD_HAS_STD_ATOMIC_WAIT")
#undef UWSIGN_UTILS_THREAD_HAS_STD_ATOMIC_WAIT
#ifndef UWSIGN_UTILS_THREAD_HAS_STD_ATOMIC_WAIT
# if defined(__cpp_lib_atomic_wait) && __cpp_lib_atomic_wait >= 201907L && !(defined(__APPLE__) && defined(_LIBCPP_VERSION))
#  define UWSIGN_UTILS_THREAD_HAS_STD_ATOMIC_WAIT 1
# endif
#endif

UWSIGN_MODULE_EXPORT namespace uwsign::utils::thread
{
#ifdef UWSIGN_UTILS_HAS_FAST_IO_NATIVE_THREAD
    ...
    struct lazy_compile_scheduler
    {
        ...
        {
#if defined(UWSIGN_UTILS_THREAD_HAS_STD_ATOMIC_WAIT)
...
#ifndef UWSIGN_UTILS_HAS_FAST_IO_NATIVE_THREAD
        this->reset_stats();
...
# endif
    ...
    struct native_thread_pool
    {
        ...
        inline void run(scheduled_task_batch& task_batch, ::std::size_t extra_worker_count) UWSIGN_THROWS
        {
...
#pragma pop_macro("UWSIGN_UTILS_THREAD_HAS_STD_ATOMIC_WAIT")
