...
UWSIGN_MODULE_EXPORT namespace uwsign::utils::hash
{
    namespace details
    {
        ...
        {
#if UWSIGN_HAS_CPP_ATTRIBUTE(__gnu__::__vector_size__) && defined(__LITTLE_ENDIAN__) && defined(__AVX512F__)
            ...
            using u8x64simd_may_alias_ptr UWSIGN_GNU_MAY_ALIAS = u8x64simd*;
...
# if UWSIGN_HAS_BUILTIN(__builtin_ia32_psrlqi512)  // Clang
            data_key_lo = ::std::bit_cast<u8x64simd>(__builtin_ia32_psrlqi512(::std::bit_cast<i64x8simd>(data_key), 32));
# elif UWSIGN_HAS_BUILTIN(__builtin_ia32_psrlqi512_mask)  // GCC
...
# endif
            ...
            u8x64simd product;
# if UWSIGN_HAS_BUILTIN(__builtin_ia32_pmuludq512)  // Clang
...
# elif UWSIGN_HAS_BUILTIN(__builtin_ia32_pmuludq512_mask)  // GCC
...
# endif
            ...
            u8x64simd data_swap;
# if UWSIGN_HAS_BUILTIN(__builtin_ia32_pshufd512)  // Clang
...
# elif UWSIGN_HAS_BUILTIN(__builtin_ia32_pshufd512_mask)  // GCC
...
# endif
            ...
            *xacc = ::std::bit_cast<u8x64simd>(::std::bit_cast<u64x8simd>(product) + ::std::bit_cast<u64x8simd>(sum));
...
#elif UWSIGN_HAS_CPP_ATTRIBUTE(__gnu__::__vector_size__) && defined(__LITTLE_ENDIAN__) && defined(__AVX2__)
            ...
            auto const acc_64aligned{::std::assume_aligned<xxh3_max_align_len>(acc)};
            using u8x32simd_may_alias_ptr UWSIGN_GNU_MAY_ALIAS = u8x32simd*;
...
# if UWSIGN_HAS_BUILTIN(__builtin_ia32_pshufd256)
...
# endif
...
#elif UWSIGN_HAS_CPP_ATTRIBUTE(__gnu__::__vector_size__) && defined(__LITTLE_ENDIAN__) && defined(__SSE2__)
            ...
            auto const acc_64aligned{::std::assume_aligned<xxh3_max_align_len>(acc)};
            using u8x16simd_may_alias_ptr UWSIGN_GNU_MAY_ALIAS = u8x16simd*;
...
#elif UWSIGN_HAS_CPP_ATTRIBUTE(__gnu__::__vector_size__) && defined(__LITTLE_ENDIAN__) &&                                                                        \
    ((defined(UWSIGN_ENABLE_SME_SVE_STREAM_MODE) && defined(__ARM_FEATURE_SME)) && !defined(__ARM_FEATURE_SVE))
            ...
            [=] __arm_locally_streaming() constexpr noexcept -> void
            {
                ...
                auto const kSwap{::uwsign::utils::intrinsics::arm_sve::sveor_n_u64_z(::uwsign::utils::intrinsics::arm_sve::svptrue_b64(),
                                                                                    ::uwsign::utils::intrinsics::arm_sve::svindex_u64(0u, 1u),
                                                                                    1u)};
                ::std::uint64_t element_count{::uwsign::utils::intrinsics::arm_sve::svcntd()};

                using uint64_t_const_may_alias_ptr UWSIGN_GNU_MAY_ALIAS = ::std::uint64_t const *;

                if(element_count >= 8u)
                {
                    auto mask{::uwsign::utils::intrinsics::arm_sve::svptrue_pat_b64(::uwsign::utils::intrinsics::arm_sve::SV_VL8)};
                    auto vacc{::uwsign::utils::intrinsics::arm_sve::svld1_u64(mask, xacc)};
                    auto accrnd{[&] UWSIGN_ALWAYS_INLINE(::uwsign::utils::intrinsics::arm_sve::svuint64_t & acc, unsigned offset) constexpr noexcept __arm_streaming -> void
                                {
                                    auto const input_vec{::uwsign::utils::intrinsics::arm_sve::svld1_u64(mask, reinterpret_cast<uint64_t_const_may_alias_ptr>(input + offset * sizeof(::std::uint64_t)))};
                                    auto const secret_vec{::uwsign::utils::intrinsics::arm_sve::svld1_u64(mask, reinterpret_cast<uint64_t_const_may_alias_ptr>(secret + offset * sizeof(::std::uint64_t)))};
                                    auto const mixed{::uwsign::utils::intrinsics::arm_sve::sveor_u64_x(mask, secret_vec, input_vec)};
                                    auto const swapped{::uwsign::utils::intrinsics::arm_sve::svtbl_u64(input_vec, kSwap)};
                                    auto const mixed_lo{::uwsign::utils::intrinsics::arm_sve::svextw_u64_x(mask, mixed)};
                                    auto const mixed_hi{::uwsign::utils::intrinsics::arm_sve::svlsr_n_u64_x(mask, mixed, 32u)};
                                    auto const mul{::uwsign::utils::intrinsics::arm_sve::svmad_u64_x(mask, mixed_lo, mixed_hi, swapped)};
                                    acc = ::uwsign::utils::intrinsics::arm_sve::svadd_u64_x(mask, acc, mul);
                                }};
                    accrnd(vacc, 0u);
                    ::uwsign::utils::intrinsics::arm_sve::svst1_u64(mask, xacc, vacc);
                }
                else if(element_count == 2u)
                { 
                    /* sve128 */
                    auto mask{::uwsign::utils::intrinsics::arm_sve::svptrue_pat_b64(::uwsign::utils::intrinsics::arm_sve::SV_VL2)};
                    auto acc0{::uwsign::utils::intrinsics::arm_sve::svld1_u64(mask, xacc + 0u)};
                    auto acc1{::uwsign::utils::intrinsics::arm_sve::svld1_u64(mask, xacc + 2u)};
                    auto acc2{::uwsign::utils::intrinsics::arm_sve::svld1_u64(mask, xacc + 4u)};
                    auto acc3{::uwsign::utils::intrinsics::arm_sve::svld1_u64(mask, xacc + 6u)};
                    auto accrnd{[&] UWSIGN_ALWAYS_INLINE(::uwsign::utils::intrinsics::arm_sve::svuint64_t & acc, unsigned offset) constexpr noexcept __arm_streaming -> void
                                {
                                    auto const input_vec{::uwsign::utils::intrinsics::arm_sve::svld1_u64(mask, reinterpret_cast<uint64_t_const_may_alias_ptr>(input + offset * sizeof(::std::uint64_t)))};
                                    auto const secret_vec{::uwsign::utils::intrinsics::arm_sve::svld1_u64(mask, reinterpret_cast<uint64_t_const_may_alias_ptr>(secret + offset * sizeof(::std::uint64_t)))};
                    ...
                    accrnd(acc2, 4u);
                    accrnd(acc3, 6u);
                    ::uwsign::utils::intrinsics::arm_sve::svst1_u64(mask, xacc + 0u, acc0);
                    ::uwsign::utils::intrinsics::arm_sve::svst1_u64(mask, xacc + 2u, acc1);
                    ::uwsign::utils::intrinsics::arm_sve::svst1_u64(mask, xacc + 4u, acc2);
                    ::uwsign::utils::intrinsics::arm_sve::svst1_u64(mask, xacc + 6u, acc3);
                }
                else
                {
                    auto mask{::uwsign::utils::intrinsics::arm_sve::svptrue_pat_b64(::uwsign::utils::intrinsics::arm_sve::SV_VL4)};
                    auto acc0{::uwsign::utils::intrinsics::arm_sve::svld1_u64(mask, xacc + 0u)};
                    auto acc1{::uwsign::utils::intrinsics::arm_sve::svld1_u64(mask, xacc + 4u)};
                    auto accrnd{[&] UWSIGN_ALWAYS_INLINE(::uwsign::utils::intrinsics::arm_sve::svuint64_t & acc, unsigned offset) constexpr noexcept __arm_streaming -> void
                                {
                                    auto const input_vec{::uwsign::utils::intrinsics::arm_sve::svld1_u64(mask, reinterpret_cast<uint64_t_const_may_alias_ptr>(input + offset * sizeof(::std::uint64_t)))};
                                    auto const secret_vec{::uwsign::utils::intrinsics::arm_sve::svld1_u64(mask, reinterpret_cast<uint64_t_const_may_alias_ptr>(secret + offset * sizeof(::std::uint64_t)))};
                    ...
                    accrnd(acc1, 4u);
                    ::uwsign::utils::intrinsics::arm_sve::svst1_u64(mask, xacc + 0u, acc0);
                    ::uwsign::utils::intrinsics::arm_sve::svst1_u64(mask, xacc + 4u, acc1);
                }
            }
            ();
...
// clang-format on
...
#elif UWSIGN_HAS_CPP_ATTRIBUTE(__gnu__::__vector_size__) && defined(__LITTLE_ENDIAN__) && defined(__ARM_FEATURE_SVE)
            ...
            if(element_count >= 8u)
            {
                auto mask{::uwsign::utils::intrinsics::arm_sve::svptrue_pat_b64(::uwsign::utils::intrinsics::arm_sve::SV_VL8)};
                auto vacc{::uwsign::utils::intrinsics::arm_sve::svld1_u64(mask, xacc)};
                auto accrnd{[&] UWSIGN_ALWAYS_INLINE(::uwsign::utils::intrinsics::arm_sve::svuint64_t & acc, unsigned offset) constexpr noexcept -> void
                            {
                                auto const input_vec{::uwsign::utils::intrinsics::arm_sve::svld1_u64(
                                    mask,
                                    reinterpret_cast<uint64_t_const_may_alias_ptr>(input + offset * sizeof(::std::uint64_t)))};
                                auto const secret_vec{::uwsign::utils::intrinsics::arm_sve::svld1_u64(
                                    mask,
...
#elif UWSIGN_HAS_CPP_ATTRIBUTE(__gnu__::__vector_size__) && defined(__LITTLE_ENDIAN__) && defined(__ARM_NEON)
...
# endif
            ...
            auto const acc_64aligned{::std::assume_aligned<xxh3_max_align_len>(acc)};
            using uint64x2_t_may_alias UWSIGN_GNU_MAY_ALIAS = uint64x2_t*;
...
# if defined(UWSIGN_XXH3_NEON_LANES)
                UWSIGN_XXH3_NEON_LANES
# else
                8uz
# endif
            };
            ...
            if constexpr(xxh3_neon_lanes != 8uz)
            {
                ...
                using uint64_t_may_alias_ptr UWSIGN_GNU_MAY_ALIAS = ::std::uint64_t*;
            ...
            auto xxh_vld1q_u64{[] UWSIGN_ALWAYS_INLINE(::std::byte const* ptr) constexpr noexcept -> uint64x2_t
                               {
                                   uint64x2_t tmp;
...
# if UWSIGN_HAS_BUILTIN(__builtin_neon_vextq_v)  // Clang
...
# elif UWSIGN_HAS_BUILTIN(__builtin_shuffle)     // GCC
...
# endif
                ...
                uint64x2_t sum_1;
                uint64x2_t sum_2;
# if UWSIGN_HAS_BUILTIN(__builtin_neon_vmull_v) && UWSIGN_HAS_BUILTIN(__builtin_shufflevector)              // Clang
                sum_1 = data_swap_1 +
                ...
                sum_2 = data_swap_2 +
                        ::std::bit_cast<uint64x2_t>(__builtin_neon_vmull_v(::std::bit_cast<int8x8_t>(__builtin_shufflevector(data_key_lo, data_key_lo, 2, 3)),
                                                                           ...
                                                                           51));
# elif UWSIGN_HAS_BUILTIN(__builtin_aarch64_umlalv2si_uuuu) && UWSIGN_HAS_BUILTIN(__builtin_shufflevector)  // GCC
...
# if UWSIGN_HAS_BUILTIN(__builtin_neon_vmovn_v)          // Clang
                data_key_lo = ::std::bit_cast<uint32x2_t>(__builtin_neon_vmovn_v(::std::bit_cast<int8x16_t>(data_key), 18));
# elif UWSIGN_HAS_BUILTIN(__builtin_aarch64_xtnv2di_uu)  // GCC
...
# if UWSIGN_HAS_BUILTIN(__builtin_neon_vshrn_n_v)            // Clang
                data_key_hi = ::std::bit_cast<uint32x2_t>(__builtin_neon_vshrn_n_v(::std::bit_cast<int8x16_t>(data_key), 32, 18));
# elif UWSIGN_HAS_BUILTIN(__builtin_aarch64_shrn_nv2di_uus)  // GCC
...
#elif UWSIGN_HAS_CPP_ATTRIBUTE(__gnu__::__vector_size__) && defined(__LITTLE_ENDIAN__) && defined(__loongarch_asx)
...
# if UWSIGN_HAS_BUILTIN(__builtin_lasx_xvld)
...
# if UWSIGN_HAS_BUILTIN(__builtin_lasx_xvshuf4i_w)
...
# if UWSIGN_HAS_BUILTIN(__builtin_lasx_xvadd_d)
...
# endif
...
#elif UWSIGN_HAS_CPP_ATTRIBUTE(__gnu__::__vector_size__) && defined(__LITTLE_ENDIAN__) && defined(__loongarch_sx)
            ...
            for(unsigned i{}; i != 4u; ++i)
            {
# if UWSIGN_HAS_BUILTIN(__builtin_lsx_vldrepl_b)
...
#elif UWSIGN_HAS_CPP_ATTRIBUTE(__gnu__::__vector_size__) && defined(__LITTLE_ENDIAN__) && defined(__wasm_simd128__)
...
# if UWSIGN_HAS_BUILTIN(__builtin_wasm_shuffle_i8x16)
...
# endif
            ...
            auto const acc_64aligned{::std::assume_aligned<xxh3_max_align_len>(acc)};
            using uint_least64_t_may_alias_ptr UWSIGN_GNU_MAY_ALIAS = ::std::uint_least64_t*;
...
# if UWSIGN_HAS_BUILTIN(__builtin_ia32_psrlqi512_mask)  // GCC
            auto const shifted{__builtin_ia32_psrlqi512_mask(::std::bit_cast<i64x8simd>(acc_vec), 47, i64x8simd{}, UINT8_MAX)};
# elif UWSIGN_HAS_BUILTIN(__builtin_ia32_psrlqi512)  // Clang
...
# if UWSIGN_HAS_BUILTIN(__builtin_ia32_psllqi512_mask)  // GCC
                                                              __builtin_ia32_psllqi512_mask(::std::bit_cast<i64x8simd>(prod_hi), 32, i64x8simd{}, UINT8_MAX)
# elif UWSIGN_HAS_BUILTIN(__builtin_ia32_psllqi512)  // Clang
...
# if UWSIGN_HAS_BUILTIN(__builtin_ia32_psllqi256)
...
# endif
            ...
            for(unsigned i{}; i != 4u; ++i)
            {
                ...
                auto const shifted{
# if UWSIGN_HAS_BUILTIN(__builtin_ia32_psrlqi128)
...
# if UWSIGN_HAS_BUILTIN(__builtin_ia32_psllqi128)
...
# endif
    ...
    for(::std::size_t i{}; i != xxh3_neon_lanes / 2uz; ++i)
    {
        ...
        auto const shifted{
# if UWSIGN_HAS_BUILTIN(__builtin_neon_vshrq_n_v)          // Clang
            ::std::bit_cast<uint64x2_t>(__builtin_neon_vshrq_n_v(::std::bit_cast<int8x16_t>(acc_vec), 47, 51))
# elif UWSIGN_HAS_BUILTIN(__builtin_aarch64_lshrv2di_uus)  // GCC
...
# endif
        ...
        *xacc = tmp_xacc;
        ...
        ++xacc;
            ...
            auto const prime32{
# if UWSIGN_HAS_BUILTIN(__builtin_lasx_xvreplgr2vr_d)
...
# endif
                ...
                *xacc =
# if UWSIGN_HAS_BUILTIN(__builtin_lasx_xvmul_d)
...
# endif
            ...
            auto const prime32{
# if UWSIGN_HAS_BUILTIN(__builtin_lsx_vreplgr2vr_d)
...
# endif
                ...
                auto const key_vec{
# if UWSIGN_HAS_BUILTIN(__builtin_lsx_vld)
...
# endif
                ...
                *xacc =
# if UWSIGN_HAS_BUILTIN(__builtin_lsx_vmul_d)
...
# endif
                                              ...
                                              ::std::size_t nbStripes) noexcept
        {
            for(::std::size_t n{}; n != nbStripes; ++n)
            {
                ...
                input += 64u;
                ::uwsign::utils::intrinsics::universal::prefetch<::uwsign::utils::intrinsics::universal::pfc_mode::read,
                                                                ::uwsign::utils::intrinsics::universal::pfc_level::L1,
                                                                ::uwsign::utils::intrinsics::universal::ret_policy::keep>(
#ifdef __AVX512F__
                    in + 512u
#else
                    in + 384u
    ...
    UWSIGN_GNU_PURE inline constexpr ::std::uint_least64_t xxh3_64bits(::std::byte const* __restrict input,
                                                                     ::std::size_t len,
