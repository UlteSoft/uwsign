...
namespace uwsign::utils::allocator::fast_io_strict
{
    ...
    inline constexpr auto fast_io_allocator_to_strict_impl() noexcept
    {
        ...
        {
            return ::uwsign::utils::allocator::fast_io_strict::fast_io_strict_nt_rtlallocateheap_allocator{};
        }
        if constexpr(::std::same_as<T, ::fast_io::win32_heapalloc_allocator>)
        {
            return ::uwsign::utils::allocator::fast_io_strict::fast_io_strict_win32_heapalloc_allocator{};
        }
#endif
#if ((__STDC_HOSTED__ == 1 && (!defined(_GLIBCXX_HOSTED) || _GLIBCXX_HOSTED == 1) && !defined(_LIBCPP_FREESTANDING)) || defined(FAST_IO_ENABLE_HOSTED_FEATURES))
        if constexpr(::std::same_as<T, ::fast_io::c_malloc_allocator>)
        {
            return ::uwsign::utils::allocator::fast_io_strict::fast_io_strict_c_malloc_allocator{};
        }
# if defined(_DEBUG) && defined(_MSC_VER)
        if constexpr(::std::same_as<T, ::fast_io::wincrt_malloc_dbg_allocator>)
        {
            return ::uwsign::utils::allocator::fast_io_strict::fast_io_strict_wincrt_malloc_dbg_allocator{};
        }
# endif
#endif
#if (defined(__linux__) && defined(__KERNEL__)) || defined(FAST_IO_USE_LINUX_KERNEL_ALLOCATOR)
        ...
        {
            return ::uwsign::utils::allocator::fast_io_strict::fast_io_strict_linux_kmalloc_allocator{};
        }
#endif
#if (defined(FAST_IO_ENABLE_MIMALLOC) || defined(FAST_IO_USE_MIMALLOC)) && (!defined(_MSC_VER) || defined(__clang__))
        ...
        {
            return ::uwsign::utils::allocator::fast_io_strict::fast_io_strict_mimalloc_allocator{};
        }
#endif
    ...
    using native_strict_global_allocator = ::uwsign::utils::allocator::fast_io_strict::fast_io_strict_generic_allocator_adapter<
        ...
        ::uwsign::utils::allocator::fast_io_strict::fast_io_strict_mimalloc_allocator
#elif (defined(__linux__) && defined(__KERNEL__)) || defined(FAST_IO_USE_LINUX_KERNEL_ALLOCATOR)
        ::uwsign::utils::allocator::fast_io_strict::fast_io_strict_linux_kmalloc_allocator
...
#  if defined(_DEBUG) && defined(_MSC_VER)
        ::uwsign::utils::allocator::fast_io_strict::fast_io_strict_wincrt_malloc_dbg_allocator
#  else
        ::std::conditional_t<::fast_io::asan::asan_status::current == ::fast_io::asan::asan_status::none,
#   ifdef _WIN32_WINDOWS
                             ::uwsign::utils::allocator::fast_io_strict::fast_io_strict_win32_heapalloc_allocator
#   else
                             ::uwsign::utils::allocator::fast_io_strict::fast_io_strict_nt_rtlallocateheap_allocator
#   endif
                             ,
                             ::uwsign::utils::allocator::fast_io_strict::fast_io_strict_c_malloc_allocator>
#  endif
# else
#  if defined(_DEBUG) && defined(_MSC_VER)
        ::uwsign::utils::allocator::fast_io_strict::fast_io_strict_wincrt_malloc_dbg_allocator
...
# endif
    ...
    using native_strict_typed_global_allocator =
        ::uwsign::utils::allocator::fast_io_strict::fast_io_strict_typed_generic_allocator_adapter<native_strict_global_allocator, T>;

    using native_strict_thread_local_allocator = ::uwsign::utils::allocator::fast_io_strict::fast_io_strict_generic_allocator_adapter<
    ...
    using native_strict_typed_thread_local_allocator =
        ::uwsign::utils::allocator::fast_io_strict::fast_io_strict_typed_generic_allocator_adapter<native_strict_thread_local_allocator, T>;
