...
UWSIGN_MODULE_EXPORT namespace uwsign::utils::utf
{
    ...
    inline constexpr ::uwsign::utils::utf::u8result check_legal_utf8_rfc3629_unchecked(char8_t const* const str_begin, char8_t const* const str_end) noexcept
    {
        ...
        if UWSIGN_IF_CONSTEVAL
        {
            ...
            while(str_curr != str_end)
            {
                ...
                if(str_curr_val < static_cast<char8_t>(0b1000'0000u))
                {
                    ...
                    {
                        if(str_curr_val == u8'\0') [[unlikely]] { return {str_curr, ::uwsign::utils::utf::utf_error_code::contains_empty_characters}; }
                    }
                ...
                else if((str_curr_val & static_cast<char8_t>(0b1110'0000u)) == static_cast<char8_t>(0b1100'0000u))
                {
                    ...
                    {
                        return {str_curr, ::uwsign::utils::utf::utf_error_code::too_short_sequence};
                    }
                    ...
                    {
                        return {str_curr, ::uwsign::utils::utf::utf_error_code::overlong_encoding};
                    }
                ...
                else if((str_curr_val & static_cast<char8_t>(0b1111'0000u)) == static_cast<char8_t>(0b1110'0000u))
                {
                    ...
                    {
                        return {str_curr, ::uwsign::utils::utf::utf_error_code::illegal_surrogate};
                    }
                ...
                else if((str_curr_val & static_cast<char8_t>(0b1111'1000u)) == static_cast<char8_t>(0b1111'0000u))
                {
                    ...
                    if(utf8_c > static_cast<char32_t>(0x10FFFFu)) [[unlikely]] { return {str_curr, ::uwsign::utils::utf::utf_error_code::excessive_codepoint}; }
                ...
                else
                {
                    ...
                    {
                        return {str_curr, ::uwsign::utils::utf::utf_error_code::too_long_sequence};
                    }
                    else
                    {
                        return {str_curr, ::uwsign::utils::utf::utf_error_code::long_header_bits};
                    }
                }
            }

            return {str_curr, ::uwsign::utils::utf::utf_error_code::success};
        }
        else
        {
#if UWSIGN_HAS_CPP_ATTRIBUTE(__gnu__::__vector_size__) && defined(__LITTLE_ENDIAN__) && defined(__AVX512BW__)
            ...
            auto general_algorithm{[&]() constexpr noexcept -> ::uwsign::utils::utf::u8result
                                   {
                                       while(str_curr != str_end)
                                       {
                                           ...
                                           if(str_curr_val < static_cast<char8_t>(0b1000'0000u))
                                           {
                                               if constexpr(zero_illegal)
                                               {
                                                   ...
                                                   {
                                                       return {str_curr, ::uwsign::utils::utf::utf_error_code::contains_empty_characters};
                                                   }
                                               }
                                           ...
                                           else if((str_curr_val & static_cast<char8_t>(0b1111'1000u)) == static_cast<char8_t>(0b1111'0000u))
                                           {
                                               ...
                                               {
                                                   return {str_curr, ::uwsign::utils::utf::utf_error_code::excessive_codepoint};
                                               }
            ...
            constexpr auto check_special_cases{
                [] UWSIGN_ALWAYS_INLINE(u8x64simd const input, u8x64simd const prev1) constexpr noexcept -> u8x64simd
                {
                    ...
                    u8x64simd b1h;
# if defined(__AVX512BW__) && UWSIGN_HAS_BUILTIN(__builtin_ia32_pshufb512_mask)  // GCC
                    b1h = __builtin_ia32_pshufb512_mask(lookup_b1h, prev1_shr4, u8x64simd{}, UINT64_MAX);
# elif defined(__AVX512BW__) && UWSIGN_HAS_BUILTIN(__builtin_ia32_pshufb512)  // Clang
...
# endif
            ...
            constexpr auto check_multibyte_lengths{
                [] UWSIGN_ALWAYS_INLINE(u8x64simd const input, u8x64simd const prev_input, u8x64simd const sc) constexpr noexcept -> u8x64simd
                {
...
# if UWSIGN_HAS_BUILTIN(__builtin_elementwise_sub_sat)  // Clang
                    prev2 = __builtin_elementwise_sub_sat(prev2, prev2_needsubs_simd);
# elif defined(__AVX512BW__) && UWSIGN_HAS_BUILTIN(__builtin_ia32_psubusb512_mask)  // GCC
...
# endif
            ...
            constexpr auto check_utf8_bytes{
                [check_special_cases, check_multibyte_lengths] UWSIGN_ALWAYS_INLINE(u8x64simd const input,
            ...
            constexpr auto is_incomplete{[] UWSIGN_ALWAYS_INLINE(u8x64simd input) constexpr noexcept -> u8x64simd
                                         {
...
# endif
            ...
            auto const rewind_for_scalar{[&] UWSIGN_ALWAYS_INLINE() constexpr noexcept
                                         {
            ...
            while(static_cast<::std::size_t>(str_end - str_curr) >= sizeof(u8x64simd))
            {
                ...
                {
                    if(
# if defined(__AVX512BW__) && UWSIGN_HAS_BUILTIN(__builtin_ia32_ucmpb512_mask)
...
# if defined(__AVX512BW__) && UWSIGN_HAS_BUILTIN(__builtin_ia32_movepi8_mask)
                    __builtin_ia32_movepi8_mask(::std::bit_cast<i8x64simd>(curr0))
# elif defined(__AVX512BW__) && UWSIGN_HAS_BUILTIN(__builtin_ia32_ucmpb512_mask)
...
# endif
                ...
                ::uwsign::utils::intrinsics::universal::prefetch<::uwsign::utils::intrinsics::universal::pfc_mode::read,
                                                                ::uwsign::utils::intrinsics::universal::pfc_level::L2,
            ...
            if(last_load_predicate_size)
            {
                ...
                using loaddquqi512_para_const_may_alias_ptr UWSIGN_GNU_MAY_ALIAS =
...
# if defined(__AVX512BW__) && UWSIGN_HAS_BUILTIN(__builtin_ia32_loaddquqi512_mask)
...
# endif
...
#elif UWSIGN_HAS_CPP_ATTRIBUTE(__gnu__::__vector_size__) && defined(__LITTLE_ENDIAN__) && (defined(__AVX2__) || defined(__loongarch_asx))
            ...
            constexpr auto check_special_cases{
                [] UWSIGN_ALWAYS_INLINE(u8x32simd const input, u8x32simd const prev1) constexpr noexcept -> u8x32simd
                {
...
# if defined(__AVX2__) && UWSIGN_HAS_BUILTIN(__builtin_ia32_pshufb256)
                    b1h = ::std::bit_cast<u8x32simd>(__builtin_ia32_pshufb256(lookup_b1h, prev1_shr4));
# elif defined(__loongarch_asx) && UWSIGN_HAS_BUILTIN(__builtin_lasx_xvshuf_b)
...
# endif
            ...
            constexpr auto check_multibyte_lengths{
                [] UWSIGN_ALWAYS_INLINE(u8x32simd const input, u8x32simd const prev_input, u8x32simd const sc) constexpr noexcept -> u8x32simd
                {
                    auto prev2{__builtin_shufflevector(prev_input,
                                                       input,
                                                       30,  // 0
...
# if UWSIGN_HAS_BUILTIN(__builtin_elementwise_sub_sat)  // Clang
                    prev2 = __builtin_elementwise_sub_sat(prev2, prev2_needsubs_simd);
# elif defined(__AVX2__) && UWSIGN_HAS_BUILTIN(__builtin_ia32_psubusb256)
                    prev2 = __builtin_ia32_psubusb256(prev2, prev2_needsubs_simd);
# elif defined(__loongarch_asx) && UWSIGN_HAS_BUILTIN(__builtin_lasx_xvssub_bu)
...
# endif
            ...
            constexpr auto check_utf8_bytes{
                [check_special_cases, check_multibyte_lengths] UWSIGN_ALWAYS_INLINE(u8x32simd const input,
            ...
            constexpr auto is_incomplete{[] UWSIGN_ALWAYS_INLINE(u8x32simd input) constexpr noexcept -> u8x32simd
                                         {
...
# endif
            ...
            while(static_cast<::std::size_t>(str_end - str_curr) >= sizeof(u8x32simd) * 2uz)
            {
                ...
                if constexpr(zero_illegal)
                {
                    ...
                    if(
# if defined(__AVX__) && UWSIGN_HAS_BUILTIN(__builtin_ia32_ptestz256)
                        !__builtin_ia32_ptestz256(::std::bit_cast<i64x4simd>(curr0_test), ::std::bit_cast<i64x4simd>(curr0_test))
# elif defined(__loongarch_asx) && UWSIGN_HAS_BUILTIN(__builtin_lasx_xbnz_v)
...
# endif
                ...
                bool const check_has_non_ascii{static_cast<bool>(
# if defined(__AVX2__) && UWSIGN_HAS_BUILTIN(__builtin_ia32_pmovmskb256)
...
# endif
...
#elif UWSIGN_HAS_CPP_ATTRIBUTE(__gnu__::__vector_size__) && UWSIGN_HAS_BUILTIN(__builtin_shufflevector) && defined(__LITTLE_ENDIAN__) &&                           \
    (defined(__SSSE3__) || defined(__ARM_NEON) || defined(__loongarch_sx))
            ...
            constexpr auto check_special_cases{
                [] UWSIGN_ALWAYS_INLINE(u8x16simd const input, u8x16simd const prev1) constexpr noexcept -> u8x16simd
                {
                    constexpr ::std::uint8_t too_short{1u << 0u};
                    // 11??'???? 0???'????
                    // 11??'???? 11??'????
...
# if defined(__SSSE3__) && UWSIGN_HAS_BUILTIN(__builtin_ia32_pshufb128)
                    b1h = ::std::bit_cast<u8x16simd>(__builtin_ia32_pshufb128(lookup_b1h, prev1_shr4));
# elif defined(__ARM_NEON) && UWSIGN_HAS_BUILTIN(__builtin_aarch64_qtbl1v16qi_uuu)  // GCC
                    b1h = __builtin_aarch64_qtbl1v16qi_uuu(lookup_b1h, prev1_shr4);
# elif defined(__ARM_NEON) && UWSIGN_HAS_BUILTIN(__builtin_neon_vqtbl1q_v)          // Clang
...
# elif defined(__loongarch_sx) && UWSIGN_HAS_BUILTIN(__builtin_lsx_vshuf_b)
...
# endif
            ...
            constexpr auto check_multibyte_lengths{
                [] UWSIGN_ALWAYS_INLINE(u8x16simd const input, u8x16simd const prev_input, u8x16simd const sc) constexpr noexcept -> u8x16simd
                {
                    auto prev2{__builtin_shufflevector(prev_input,
                                                       input,
                                                       14,  // 0
...
# if UWSIGN_HAS_BUILTIN(__builtin_elementwise_sub_sat)  // Clang
                    prev2 = __builtin_elementwise_sub_sat(prev2, prev2_needsubs_simd);
# elif defined(__SSE2__) && UWSIGN_HAS_BUILTIN(__builtin_ia32_psubusb128)
                    prev2 = __builtin_ia32_psubusb128(prev2, prev2_needsubs_simd);
# elif defined(__ARM_NEON) && UWSIGN_HAS_BUILTIN(__builtin_aarch64_ussubv16qi_uuu)  // GCC
                    prev2 = __builtin_aarch64_ussubv16qi_uuu(prev2, prev2_needsubs_simd);
# elif defined(__ARM_NEON) && UWSIGN_HAS_BUILTIN(__builtin_neon_vqsubq_v)           // Clang
...
# elif defined(__loongarch_sx) && UWSIGN_HAS_BUILTIN(__builtin_lsx_vssub_bu)
...
# endif
            ...
            constexpr auto check_utf8_bytes{
                [check_special_cases, check_multibyte_lengths] UWSIGN_ALWAYS_INLINE(u8x16simd const input,
            ...
            constexpr auto is_incomplete{[] UWSIGN_ALWAYS_INLINE(u8x16simd input) constexpr noexcept -> u8x16simd
                                         {
...
# endif
            ...
            while(static_cast<::std::size_t>(str_end - str_curr) >= sizeof(u8x16simd) * 4uz)
            {
                ...
                if constexpr(zero_illegal)
                {
                    ...
                    if(
# if defined(__SSE4_1__) && UWSIGN_HAS_BUILTIN(__builtin_ia32_ptestz128)
                        !__builtin_ia32_ptestz128(::std::bit_cast<i64x2simd>(curr0_test), ::std::bit_cast<i64x2simd>(curr0_test))
# elif defined(__SSE2__) && UWSIGN_HAS_BUILTIN(__builtin_ia32_pmovmskb128)
                        __builtin_ia32_pmovmskb128(::std::bit_cast<c8x16simd>(curr0_test))
# elif defined(__wasm_simd128__) && UWSIGN_HAS_BUILTIN(__builtin_wasm_all_true_i8x16)
                        !__builtin_wasm_all_true_i8x16(::std::bit_cast<i8x16simd>(~curr0_test))
# elif defined(__wasm_simd128__) && UWSIGN_HAS_BUILTIN(__builtin_wasm_bitmask_i8x16)
                        __builtin_wasm_bitmask_i8x16(::std::bit_cast<i8x16simd>(curr0_test))
# elif defined(__ARM_NEON) && UWSIGN_HAS_BUILTIN(__builtin_neon_vmaxvq_u32)                  // Only supported by clang
                        __builtin_neon_vmaxvq_u32(::std::bit_cast<u32x4simd>(curr0_test))
# elif defined(__ARM_NEON) && UWSIGN_HAS_BUILTIN(__builtin_aarch64_reduc_umax_scal_v4si_uu)  // Only supported by GCC
                        __builtin_aarch64_reduc_umax_scal_v4si_uu(::std::bit_cast<u32x4simd>(curr0_test))
# elif defined(__loongarch_sx) && UWSIGN_HAS_BUILTIN(__builtin_lsx_bnz_v)
...
# endif
                ...
                bool const check_has_non_ascii{static_cast<bool>(
# if defined(__SSE2__) && UWSIGN_HAS_BUILTIN(__builtin_ia32_pmovmskb128)
                    __builtin_ia32_pmovmskb128(::std::bit_cast<c8x16simd>(check_or))
# elif defined(__wasm_simd128__) && UWSIGN_HAS_BUILTIN(__builtin_wasm_bitmask_i8x16)
                    __builtin_wasm_bitmask_i8x16(::std::bit_cast<i8x16simd>(check_or))
# elif defined(__ARM_NEON) && UWSIGN_HAS_BUILTIN(__builtin_neon_vmaxvq_u8)                   // Only supported by clang
...
#elif UWSIGN_HAS_CPP_ATTRIBUTE(__gnu__::__vector_size__) && defined(__LITTLE_ENDIAN__) && (defined(__SSE2__) || defined(__wasm_simd128__))
...
# endif
                ...
                if(str_curr == str_end) [[unlikely]] { return {str_curr, ::uwsign::utils::utf::utf_error_code::success}; }

                while(*str_curr < static_cast<char8_t>(0b1000'0000u))
                {
                    if constexpr(zero_illegal)
                    {
                        if(*str_curr == u8'\0') [[unlikely]] { return {str_curr, ::uwsign::utils::utf::utf_error_code::contains_empty_characters}; }
                    }
                ...
                if(static_cast<::std::size_t>(str_end - str_curr) >= sizeof(::std::uint_least32_t)) [[likely]]
                {
                    ...
                    if((utf_8 & static_cast<::std::uint_least32_t>(0b1110'0000u)) == static_cast<::std::uint_least32_t>(0b1100'0000u))
                    {
                        ...
                        if(utf8_mask_C0C0C000 != checker) [[unlikely]] { return {str_curr, ::uwsign::utils::utf::utf_error_code::too_short_sequence}; }
    ...
    inline constexpr ::uwsign::utils::utf::u8result check_legal_utf8_unchecked(char8_t const* const str_begin, char8_t const* const str_end) noexcept
    {
    ...
    template <utf8_specification spec>
        requires (static_cast<unsigned>(spec) <= static_cast<unsigned>(utf8_specification::utf8_rfc3629_and_zero_illegal))
    inline constexpr ::uwsign::utils::utf::u8result check_legal_utf8(char8_t const* const str_begin, char8_t const* const str_end) noexcept
    {
